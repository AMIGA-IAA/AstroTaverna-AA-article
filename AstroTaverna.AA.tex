...
\begin{figure}[tb]
\centering
%Use resizebox as per http://www.aanda.org/index.php?option=com_content&task=view&id=171&Itemid=173#tables&figures
\resizebox{\hsize}{!}{\includegraphics{VOArch}} 
...
\begin{figure}[tb]
\centering 
\resizebox{\hsize}{!}{\includegraphics{VODiscovery}}
...
\begin{figure}[tb]
\centering 
\resizebox{\hsize}{!}{\includegraphics{design}}
